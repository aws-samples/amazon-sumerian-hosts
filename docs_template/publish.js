...
const env = require('../node_modules/jsdoc/lib/jsdoc/env');
const fs = require('../node_modules/jsdoc/lib/jsdoc/fs');
const helper = require('../node_modules/jsdoc/lib/jsdoc/util/templateHelper');
const logger = require('../node_modules/jsdoc/lib/jsdoc//util/logger');
const path = require('../node_modules/jsdoc/lib/jsdoc/path');
const template = require('../node_modules/jsdoc/lib/jsdoc/template');
const doop = require('../node_modules/jsdoc/lib/jsdoc/util/doop');
...
exports.publish = (taffyData, opts, tutorials) => {
  ...
  if (conf.default.staticFiles) {
    ...
    staticFileFilter = new (require('../node_modules/jsdoc/lib/jsdoc/src/filter').Filter)(
      conf.default.staticFiles
    );
    staticFileScanner = new (require('../node_modules/jsdoc/lib/jsdoc/src/scanner').Scanner)();
